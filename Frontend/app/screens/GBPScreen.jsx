...
const ConvertFromGBPScreen = () => {
  ...
  const handleConvert = () => {
    ...
    const rate = transferRates['GBP']?.[toWallet] || 1;
  ...
  return (
    <KeyboardAvoidingView style={[styles.container, { backgroundColor }]} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <Text style={[styles.title, { color: textColor }]}>Transfer from GBP</Text>
...
export default ConvertFromGBPScreen;
